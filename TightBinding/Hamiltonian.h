...
namespace TightBinding
{
	...
	protected:
		std::complex<double> g0(const Vector3D<double>& k) const;
		std::complex<double> g1(const Vector3D<double>& k) const;
		std::complex<double> g2(const Vector3D<double>& k) const;
		std::complex<double> g3(const Vector3D<double>& k) const;
